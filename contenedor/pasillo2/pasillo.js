document.addEventListener('DOMContentLoaded', () => {
    ...
    const initialProducts = [
        "JABON EN POLVO", "DETERGENTE LIQUIDO", "SUAVIZANTE TELAS",
        "LIMPIAPISOS 1L", "DESINFECTANTE", "ESPONJA COCINA",
        "PAÑO MICROFIBRA", "LAVAPLATOS CREMA", "LAVAPLATOS LIQ", "DESENGRASANTE"
    ];
